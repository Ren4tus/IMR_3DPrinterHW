...
public class MJP_ToolTipController : AnimatedUI
{
    ...
    public void SetContentsByName(string name)
    {
        switch (name)
        {
            ...
            case "Awl":
                TitleUI.text = "송곳";
                ContentUI.text = "레진 뚜껑의 구멍을 뚫을 때 사용합니다.";
                break;

            case "Clipper":
                TitleUI.text = "클리퍼";
                ContentUI.text = "조형물 회수 시 사용합니다.";
                break;

            case "Grinder":
                TitleUI.text = "그라인더";
                ContentUI.text = "조형이 완료된 조형물을 다듬을 때 사용합니다.";
                break;

            case "Resin":
                TitleUI.text = "레진";
                ContentUI.text = "조형에 필요한 재료입니다.";
                break;
