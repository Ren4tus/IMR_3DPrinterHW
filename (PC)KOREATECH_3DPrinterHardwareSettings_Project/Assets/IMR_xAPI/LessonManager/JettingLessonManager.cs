...
{
    private List<Dictionary<string, int>> result_statements;
    ...
    public sealed override void Init()
    {
        ...
        result_statements = new List<Dictionary<string, int>>();
        ...
        _hintText = "프린터 상태는 프린터 인터페이스 창에서 확인할 수 있습니다.";
        _hintCount = 1;
    ...
    public void SetHintStatementResultExtensions(string hintText)
    {
        _hintText = hintText;
