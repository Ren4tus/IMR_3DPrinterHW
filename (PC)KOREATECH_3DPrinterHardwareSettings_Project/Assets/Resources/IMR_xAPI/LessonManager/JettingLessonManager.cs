...
public class JettingLessonManager : Lesson
{
    ...
    {
        lessonName = "material-jetting-3Dprinter";
    ...
    public void SetObject()
    {
        ...
        _choice_statement.SetActivity("3DPrinterHWSetting/verbs/material-jetting-3Dprinter/selection");
        _time_limite_statement.SetActivity("3DPrinterHWSetting/verbs/material-jetting-3Dprinter/limit-time");
        ...
        _hint_Statement.SetActivity("3DPrinterHWSetting/verbs/material-jetting-3Dprinter/hint");
        ...
        _init_statement.SetContextExtensionLesson("material-jetting-3Dprinter");
        _choice_statement.SetContextExtensionLesson("material-jetting-3Dprinter");
        _time_limite_statement.SetContextExtensionLesson("material-jetting-3Dprinter");
        _jettingTerminateStatement.SetContextExtensionLesson("material-jetting-3Dprinter");
    ...
    public override void CloneResultCanvas(EvaluationCore.EvaluationContainer SequenceConatiner)
    {
        ...
        Dictionary<string, string> newItem3 = new Dictionary<string, string>()
        {
            {"시간 내 작업할 수 있다.", (EvaluationSceneController.Instance.IsCompleteInTime) ? "PASS" : "FAIL"}
        };
        result_statements.Add(newItem3);
