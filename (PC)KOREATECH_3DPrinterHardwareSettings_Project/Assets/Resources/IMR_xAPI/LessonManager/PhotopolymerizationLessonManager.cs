...
public class PhotopolymerizationLessonManager : Lesson
{
    ...
    {
        lessonName = "photopolymerization-3Dprinter";
    ...
    public void SetObject()
    {
        ...
        _choice_statement.SetActivity("3DPrinterHWSetting/verbs/photopolymerization-3Dprinter/selection");
        _time_limite_statement.SetActivity("3DPrinterHWSetting/verbs/photopolymerization-3Dprinter/limit-time");
        ...
        _hint_Statement.SetActivity("3DPrinterHWSetting/verbs/photopolymerization-3Dprinter/hint");
        ...
        _init_statement.SetContextExtensionLesson("photopolymerization-3Dprinter");
        _choice_statement.SetContextExtensionLesson("photopolymerization-3Dprinter");
        _time_limite_statement.SetContextExtensionLesson("photopolymerization-3Dprinter");
        _jettingTerminateStatement.SetContextExtensionLesson("photopolymerization-3Dprinter");
